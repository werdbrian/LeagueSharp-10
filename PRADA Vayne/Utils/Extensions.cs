    ...
    internal static class Extensions
    {
        ...
        public static Vector3 GetTumblePos(this Obj_AI_Hero target)
        {
            ...
            foreach (var p in aRC)
            {
                ...
                if (v3.Distance(tP) > 425 && v3.Distance(tP) < 550 && (v3.CountEnemiesInRange(425) <= v3.CountAlliesInRange(325) && ((Player.UnderTurret(true) && Program.Orbwalker.ActiveMode == MyOrbwalker.OrbwalkingMode.Combo) || !v3.UnderTurret(true)))) return v3;
            }
            return Vector3.Zero;
        }
